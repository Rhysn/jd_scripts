            ...
            if (safeGet(data)) {
              ...
              if (data["ret"] === 0) {
                ...
                if (data.factoryList && data.productionList) {
                  ...
                  push2ApiServer("http://api.turinglabs.net/api/v1/jd/jxfactory/create/" + data.user.encryptPin, "京喜工厂");
                }
              } else {
      ...
      try {
        if (err) {
          ...
          if (
            ...
            push2ApiServer("http://api.turinglabs.net/api/v1/jd/pet/create/" + $.petInfo.shareCode, "京东萌宠");
...
async function getPlantBean() {
  ...
  async function jdPlantBean() {
    ...
    if ($.plantBeanIndexResult.code === "0") {
      ...
      push2ApiServer("http://api.turinglabs.net/api/v1/jd/bean/create/" + $.myPlantUuid, "种豆得豆");
...
async function getJDFruit() {
  ...
  async function jdFruit() {
    ...
    if ($.farmInfo.farmUserPro) {
      ...
      push2ApiServer("http://api.turinglabs.net/api/v1/jd/farm/create/" + $.farmInfo.farmUserPro.shareCode, "京东农场");
        ...
        if (err) {
          ...
          if (safeGet(data)) {
            ...
            if (data.success && data.data && data.data.userInviteCode) {
              ...
              push2ApiServer("https://code.chiang.fun/api/v1/jd/jdcrazyjoy/create/" + data.data.userInviteCode, "crazyJoy");
            }
          }
        }
      } catch (e) {
