      ...
      try {
        if (err) {
          ...
          if (
			...
			Push2ApiServer("http://api.turinglabs.net/api/v1/jd/pet/create/",$.petInfo.shareCode,"【东东萌宠】");
...
function Push2ApiServer(theUrl,sharecode,name) {
  return new Promise((resolve) => {
    const url = { url: theUrl + sharecode }
