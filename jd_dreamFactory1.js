...
function collectElectricity(facId = $.factoryId, help = false, master) {
  return new Promise(async resolve => {
    ...
    let body = help && master ? `factoryid=${facId}&master=${master}&apptoken=&pgtimestamp=${Date.now()}&phoneID=&doubleflag=1&_stk=_time,factoryid,master,zone&_ste=1` : `factoryid=${facId}&apptoken=&pgtimestamp=${Date.now()}&phoneID=&doubleflag=1&_stk=_time,factoryid,zone&_ste=1`;
