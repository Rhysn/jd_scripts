...
let PetShareCodes = [
  'MTAxODc2NTEzNTAwMDAwMDAyMzMzNjQyNQ==@MTAxODcxOTI2NTAwMDAwMDAzMjg3OTc3Mw==@MTAxODc2NTEzMDAwMDAwMDAyNDcxMjYwOQ==',//账号一的好友shareCode,不同好友中间用@符号隔开
  'MTAxODc2NTEzNTAwMDAwMDAyMzMzNjQyNQ==@MTAxODcxOTI2NTAwMDAwMDAzMjg3OTc3Mw==@MTAxODc2NTEzMDAwMDAwMDAyNDcxMjYwOQ==',//账号二的好友shareCode，不同好友中间用@符号隔开
]
