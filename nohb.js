...
const $ = new Env('互助码')
$.zdUrl = 'http://api.turinglabs.net/api/v1/jd/bean/create/olmijoxgmjuty7ysw2cnmh4hc2mdq4qvqqgduey/'  // 种豆得豆
$.ncUrl = 'http://api.turinglabs.net/api/v1/jd/farm/create/8c56a42c42014d21b3f7d0700c4c525d/'  // 农场
$.mcUrl = 'http://api.turinglabs.net/api/v1/jd/pet/create/MTEzMzI0OTE0NTAwMDAwMDA0MjUzNTc3Mw==/'  // 萌宠
$.ddUrl = 'http://api.turinglabs.net/api/v1/jd/ddfactory/create/P04z54XCjVWnYaS5m9cZ2b82y1JljHihiB4JBk/'  // 东东
$.jxUrl = 'http://api.turinglabs.net/api/v1/jd/jxfactory/create/WdMJ6_QURO7j26KcNRIxVA==/'  // 惊喜
$.jdzzUrl = 'https://code.chiang.fun/api/v1/jd/jdzz/create/AUWE5mamWnDYLDWHxi3gYxw/'  // 京东赚赚
