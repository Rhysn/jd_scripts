...
const shareCodeArr2 = ['P04z54XCjVWmIaW5mlRVjyhg31PkxxRQQA', 'P04z54XCjVXnIaW5mlRVjyhg31PkzULYoQ', 'P04z54XCjVUnoaW5mlRVjyhg31Pk5yQ45A', 'P04z54XCjVUloaW5mlRVjyhg31PkwB1JXc', 'P04z54XCjVUmYaW5m9cZ2f-3n0YlCj8l1OiUl8', 'T0184qQtHEdH9FHRJBn3kQCjVVmIaW5kRrbA', 'T0184qQtHEdH9FHRJBn3kQCjVVl4aW5kRrbA', 'T0184qQtHEdH9FHRJBn3kQCjVVloaW5kRrbA'];
...
!(async () => {
    ...
    for (let i = 0; i < cookiesArr.length; i++) {
        ...
        if (cookie) {
            ...
            const taskInfoJson = await readTaskInfo(taskInfoPath);

            shareCodeList = new Array();
            ...
            if (taskInfoJson && taskInfoJson.code === 200) {
                ...
                for (let item of taskInfoJson.data) {
                    ...
                    homeDataFunPrefix = item.homeData;
                ...
                try {
                    ...
                    for (let i = 0; i < data.data.result.taskVos.length; i++) {
                        ...
                        if ([14, 6].includes(data.data.result.taskVos[i].taskType)) {
                            ...
                            for (let item of shareCodeList) await harmony_collectScore(item, data.data.result.taskVos[i].taskId);
