...
//此处填入你需要助力好友的京东用户名
//下面给出好友邀请助力的示例填写规则
let invite_pins = ["jd_7631b126655b6,linlin1564335,jd_617ba2f361afa"];
//下面给出好友赛跑助力的示例填写规则
let run_pins = ["jd_7631b126655b6,linlin1564335,jd_617ba2f361afa"];
let temp = run_pins[0].split(',')
let fixPins = temp.splice(temp.indexOf('jd_7631b126655b6'), 1);
fixPins.push(...temp.splice(temp.indexOf('linlin1564335'), 1));
...
let friendsArr = ["jd_7631b126655b6","linlin1564335","jd_617ba2f361afa"]
