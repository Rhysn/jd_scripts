...
$.newShareCodes = ["c109aca795272b05dc47ee19723b864b","dd26e15d5af2d531dbc683e5cd09e90c","ab3fbdac94556801cf8b9443256c6194","ea3731c03e54fdb27937c5ceeee203bf"];
!(async () => {
  if (!cookiesArr[0]) {
  ...
  await getAuthorShareCode('https://allgreat.xyz/Scripts/JD/InviteCodes/jd_jdh.json');
  for (let i = 0; i < cookiesArr.length; i++) {
    if (cookiesArr[i]) {
      cookie = cookiesArr[i];
      await helpFriends()
